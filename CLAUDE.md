...
### 2026-07-13 (7) — งบแสดงฐานะการเงิน: เปลี่ยน KPI เป็น "ภาพรวมฐานะการเงิน" ฟีลเดียวกับ Exec Cash Flow
- **เจ้าของงง:** หนี้สิน 5.42 ล้าน โผล่ข้างสินทรัพย์ 1.05 ล้าน ดูไม่สมดุล · ลองใส่แถบสมการ (`=` `+`) แต่เจ้าของบอก "แปลก" → ขอฟีลการ์ด gradient แบบหน้า Cash Flow แทน
- **`.fin-cfhero`** (แทน `.fin-kpis` + แถบสมการเดิม): 2 การ์ด gradient (สินทรัพย์=inGrad ฟ้า/teal · หนี้สิน=outGrad ส้ม/ชมพู · reuse gradient ต่อบริษัทของ edRenderSummary) + แถบสัดส่วน · กล่องสรุป **ส่วนของผู้ถือหุ้น = สินทรัพย์ − หนี้สิน** (แดงถ้าติดลบ/เขียวถ้าบวก · ↓/↑ · เหมือน net ของ Cash Flow) · meta โชว์ asOf + เงินสด
- **กระทบหน้าอื่น = 0** · P&L ยังใช้ 4 KPI เดิม (เจ้าของชอบ) · เฉพาะ balance เปลี่ยนเป็น hero band
