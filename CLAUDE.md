...
### 2026-07-13 (7) — งบแสดงฐานะการเงิน: แถบสมการงบดุล (สินทรัพย์ = หนี้สิน + ส่วนของผู้ถือหุ้น)
- **เจ้าของงง:** หนี้สิน 5.42 ล้าน โผล่ข้างสินทรัพย์ 1.05 ล้าน ดูไม่สมดุล (จริง ๆ สมดุลเพราะทุนติดลบ)
- **KPI ใบ 4** เปลี่ยน เงินสด → **"หนี้สิน + ส่วนของผู้ถือหุ้น"** (=รวมสินทรัพย์ · badge "สมดุล ✓") · **แถบสมการ `.fin-baleq`** สินทรัพย์ = หนี้สิน + ทุน + badge สมดุล · **note (เมื่อทุนติดลบ)** อธิบาย หนี้สิน − ส่วนติดลบ = สินทรัพย์ + เงินสดในมือ
- **กระทบหน้าอื่น = 0** (finBalanceHtml KPI + CSS `.fin-baleq*`)
