...
### 2026-07-13 (7) — งบแสดงฐานะการเงิน: hero = สมการบัญชี (สินทรัพย์ = หนี้สินและส่วนของเจ้าของ) แล้วแตกย่อย
- **เจ้าของ iterate 3 รอบ:** (1) KPI เดิมงง (หนี้ 5.42M ข้างสินทรัพย์ 1.05M) (2) ลองแถบสมการ `=`/`+` → "แปลก" (3) ลอง gradient 2 การ์ด (สินทรัพย์/หนี้สิน) + net ส่วนของผู้ถือหุ้น → **ยังไม่ใช่** · เจ้าของต้องการ **สมการบัญชี 2 ช่องที่เท่ากันก่อน** (สินทรัพย์ = หนี้สินและส่วนของเจ้าของ) แล้วช่องขวาค่อยแตกเป็น หนี้สิน / ส่วนของเจ้าของ
- **`.fin-cfhero` (final):** `.cfh-eq` = grid `1fr auto 1fr` → การ์ด **สินทรัพย์** (inGrad ฟ้า/teal) · เครื่องหมาย **`=`** · การ์ด **หนี้สินและส่วนของเจ้าของ = L+E** (outGrad ส้ม/ชมพู · **ค่าเท่าสินทรัพย์เสมอ** เพราะ LE=L+(A−L)=A) · badge "สมดุล ✓" ที่ meta · กล่อง `.cfh-break` ใต้: **หนี้สิน (L) + ส่วนของเจ้าของ (E)** + แถบสัดส่วน (หนี้=ส้ม · ทุน=เขียว/แดงถ้าติดลบ) + warn เมื่อ E<0 (ขาดทุนเกินทุน)
- **gradient ต่อบริษัท** reuse ของ edRenderSummary (mbark ฟ้า/ส้ม · benya teal/ชมพู) · responsive: `=`/`+` หมุน 90° + stack เมื่อจอแคบ
- **กระทบหน้าอื่น = 0** · P&L ยังใช้ 4 KPI เดิม · verify preview (seed MBark): 1,053,211.11 = 1,053,211.11 · หนี้ 5,423,191.17 + ทุน (4,369,980.06) แดง · สมดุล ✓
